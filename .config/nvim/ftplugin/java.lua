...
local config = {
  ...
  settings = {
    java = {
      ...
      home = 'home/mhufnagel/.sdkman/candidates/java/21-tem/',
      eclipse = {
      ...
      configuration = {
        ...
        runtimes = {
          {
            name = "JavaSE-11",
            -- path = vim.env.home .. "/.sdkman/candidates/java/11.0.7-amzn/",
            path = "/home/mhufnagel/.sdkman/candidates/java/11.0.7-amzn/",
          },
          {
            name = "JavaSE-1.8",
            -- path = vim.env.home .. "/.sdkman/candidates/java/8.0.412-amzn/",
            path = "/home/mhufnagel/.sdkman/candidates/java/8.0.412-amzn/",
          },
        }
      },
      maven = {
