...
-- Map Ctrl+S to save the file in normal, insert, and visual mode
keymap.set('n', '<C-s>', ':w<CR>', { noremap = true, silent = true })
keymap.set('i', '<C-s>', '<Esc>:w<CR>a', { noremap = true, silent = true })
keymap.set('v', '<C-s>', '<Esc>:w<CR>', { noremap = true, silent = true })
keymap.set("n", "dd", "\"_dd")
keymap.set("v", "d", "\"_d")
keymap.set("n", "<leader>/", function() vim.cmd('normal gcc') end, { silent = true })
...
keymap.set("n", "<leader>et", ":NvimTreeRefresh<CR>")  -- refresh file explorer
...
keymap.set('n', '<leader>fc', require('telescope.builtin').command_history, {})
...
-- keymap.set("n", "<leader>Gr", ":Gitsigns reset_hunk<CR>", { noremap = true })
-- keymap.set("n", "<leader>GR", ":Gitsigns reset_buffer<CR>", { noremap = true })
-- keymap.set("n", "<leader>GS", ":Gitsigns stage_hunk<CR>", { noremap = true })
-- keymap.set("n", "<leader>GU", ":Gitsigns undo_stage_hunk<CR>", { noremap = true })
